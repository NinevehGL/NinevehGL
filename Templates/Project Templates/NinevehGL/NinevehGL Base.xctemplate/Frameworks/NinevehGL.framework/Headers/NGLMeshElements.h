...
/*!
 *					The stride of elements in the array of structures. This stride is given in number
 *					of elements. However, OpenGL requires stride in basic machine units (bytes).
 *
 *					The stride can't be 0, so its minimum value is 1.
 */
