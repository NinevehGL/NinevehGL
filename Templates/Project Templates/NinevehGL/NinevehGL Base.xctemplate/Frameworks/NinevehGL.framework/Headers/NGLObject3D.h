 ...
 *					object structure.
 *
 *					The NinevehGL stores some kinds of information inside the bounding box structure to
 *					optimize the performance. Those information work like caches for future calculations.
 *
