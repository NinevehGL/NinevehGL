...
/*!
 *					A pointer to the #NGLView# instance that holds this core instance.
 *
 *	@see			NGLView
 */
@property (nonatomic, assign) NGLView *parent;
 ...
 *
 *					This method initializes a core instance and set its #layer# property.
 *
 *	@param			view
 ...
 */
- (id) initWithParent:(NGLView *)view;
