...
/*!
 *					Defines the NGLShader protocol.
 *
 *					This protocol defines the NGLShader kind, it can be produce many NGLShader types,
 *					like:
 *
 *						- Standard;
 *						- Multi/Sub.
 */
@protocol NGLShader <NSObject, NGLCopying>
 ...
 *					variable value.
 *
 *					NGLShader is identified by its <code>#identifier#</code> property (ID). If its ID
 ...
 *	@see			NGLSurface
 */
@interface NGLShader : NSObject <NGLShader>
{
@private
...
/*!
 *					This is the source for the custom Vertex Shader.
 */
@property (nonatomic, readonly) NGLSLSource *vertex;

/*!
 *					This is the source for the custom Fragment Shader.
 */
...
/*!
 *					Initializes this NGLShader with one or two shaders inside based on source code.
 ...
 *
 *	@result			A new initialized NGLShader instance.
 */
- (id) initWithSourcesVertex:(NSString *)vsh andFragment:(NSString *)fsh;

/*!
 *					Initializes this NGLShader with one or two shader inside based on files. This method
...
/*!
 *					Replaces the current source by one or two other sources string. The source must be
 *					inside a NSString.
 *
 *	@param			vsh
 *					A NSString containing source code for the vertex shader.
 ...
 *					A NSString containing source code for the fragment shader.
 */
- (void) setSourcesVertex:(NSString *)vsh andFragment:(NSString *)fsh;

/*!
 *					Replaces the current source by one or two files of shaders source.
 *
 *	@param			vshPath
 *					A NSString representing the file path for the vertex shader.
 *
 ...
 *					A NSString representing the file path for the fragment shader.
 */
- (void) setFilesVertex:(NSString *)vshPath andFragment:(NSString *)fshPath;
...
/*!
 *					Resets this shaders source, variables and any other information on this shader.
 */
- (void) reset;
 ...
 *
 *					This method creates an empty shader object.
 *
 ...
 *					A NSString containing source code for the fragment shader.
 *
 *	@result			A NGLShader autoreleased instance.
 */
