...
/*!
 *					Returns an autoreleased instance of NGLMaterial.
 *
...
/*!
 *					Returns a matte material (opaque without lights) with the black color. This means the
 *					final aspect will be a full black.
 *
 *	@result			A NGLMaterial autoreleased instance.
 */
+ (id) materialMattedBlack;


/*!
 *					Returns a matte material (opaque without lights) with a random color.
 *
 *	@result			A NGLMaterial autoreleased instance.
 */
+ (id) materialMattedRandom;
