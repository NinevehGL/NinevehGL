...
/*!
 *					Generates an error instantly at the console panel. The output on the panel is
 *					generated without any allocation based on a header and a message.
 *
 *	@param			header
 ...
 */
NGL_API void nglErrorShow(NSString *header, NSString *message);
