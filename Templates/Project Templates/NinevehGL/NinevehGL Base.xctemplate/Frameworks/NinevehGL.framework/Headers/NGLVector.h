...
/*!
 *					This function generates a random color. You can define if this color will be opaque or
 *					not, that means, if its alpha value will be exactly 1.0 or any random value.
 *
 *					All the color component values are within the range [0.0, 1.0].
 *
 *	@result			A NGLvec4 with a random color.
 */
NGL_API NGLvec4 nglColorRandom(BOOL isOpaque);
...
/*!
 *					This function generates a color based on an hexadecimal color. The color will be
 ...
 *	@result			A NGLvec4 with the desired color.
 */
NGL_API NGLvec4 nglColorFromHexadecimalRGB(unsigned int hex);

/*!
 *					This function generates a color based on an hexadecimal color. The generated color
 *					will be in RGBA color format. Its hexadecimal value must be in RGBA format (0xNNNNNN).
 *
 *	@param			hex
 *					A color in hexadecimal notation (0xNNNNNN).
 *
 *	@result			A NGLvec4 with the desired color.
 */
NGL_API NGLvec4 nglColorFromHexadecimalRGBA(unsigned int hex);
