...
/*!
 *					The NGLCoreMesh protocol defines the basic methods for a mesh in NinevehGL.
 *
...
/*!
 *					A pointer to the #NGLMesh# instance that holds this core instance.
 *
 *	@see			NGLMesh
 */
 ...
 *
 *					This method initializes a core mesh and sets its #parent# property.
 *
 *	@param			mesh
 ...
 *
 *					This method constructs the bridge between NinevehGL information and the OpenGL.
 *
